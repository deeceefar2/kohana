<?php
/**
 * API class for Bookmarks
 *
 * @package    MedVoyager
 * @author     David Farnan
 * @copyright  (c) 2011 Colorful Studio
 */
class Controller_API_Bookmarks extends Controller_API
{

	protected $_model = false;

	protected $_object_name = 'bookmark';
	...
	public function get()
	{
		...
		$this->_response_payload = $object->with('listing:default_image')->with('listing:default_category')->as_array();
	}
	...
	{
		$this->_response_payload = $this->_model->with('listing:default_image')->with('listing:default_category')->find_all()->as_array();
	}
	...
	public function post_collection()
	{
		...
		$this->_response_payload  = $this->_model->with('listing:default_image')->with('listing:default_category')->as_array();
	}
