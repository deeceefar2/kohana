						...
						<form class="registerForm" method="post">
							...
							<dl class="formSection">
								...
								<dd class="formSubmit floatLeft">
									<input class="formButton floatRight" type="submit" value="Request Flyers" tabindex="12"/>
								</dd>
							</dl>
						</form>
						<div class="clearer"></div>
						<h4 class="sectionTitle">Front</h4>
						<img src="/assets/images/theme/content/medvoyager_flyer_03_salesrep1.jpg" width="450"/>
					</div>
					<div class="floatRight">
						<h4 class="sectionTitle">Back</h4>
